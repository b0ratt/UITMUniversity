namespace UITMUniversity.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<UITMUniversity.DAL.UniversityContext>
    {
        ...
        protected override void Seed(UITMUniversity.DAL.UniversityContext context)
        {
        ...
        void AddOrUpdateInstructor(UniversityContext context, string courseTitle, string InstructorName)
        {
